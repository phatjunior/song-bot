...
def a(client, message):
    ...
    try:
        ...
        m.edit(
            "**Ничего не могу найти по данному запросу.. Возможно неправильная ссылка, Похоже у нас проблемы, о которых должен знать <a href="{https://t.me/phatBeats}">{разработчик}</a>.**"
        )
        print(str(e))
        return
